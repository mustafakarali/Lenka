...
$config['Thumbnails'] = array(
        'url' => $baseUrl.'_thumbs438',
        'directory' => $baseDir.'_thumbs438',
        'enabled' => true,
        'directAccess' => true,
        'maxWidth' => 438,
        'maxHeight' => 438,
...
$config['Thumbnails'] = array(
        'url' => $baseUrl.'_thumbs242',
        'directory' => $baseDir.'_thumbs242',
        'enabled' => true,
        'directAccess' => true,
        'maxWidth' => 242,
        'maxHeight' => 242,
...
$config['ResourceType'][] = array(
        'name' => 'Musics',                // Single quotes not allowed
        'url' => $baseUrl.'_musics',
        'directory' => $baseDir.'_musics',
        'maxSize' => 0,
        'allowedExtensions' => 'mp3',
        'deniedExtensions' => '', );

$config['ResourceType'][] = array(
        'name' => 'Profiles',                // Single quotes not allowed
        'url' => $baseUrl.'_profiles',
        'directory' => $baseDir.'_profiles',
        'maxSize' => 0,
        'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
        'deniedExtensions' => '', );
...
$config['ResourceType'][] = array(
        ...
        'url' => $baseUrl.'_videos',
        'directory' => $baseDir.'_videos',
        'maxSize' => 0,
        'allowedExtensions' => 'mpeg,avi,mov',
        'deniedExtensions' => '', );
/*
$config['ResourceType'][] = Array(
        'name' => 'Flash',
