 ...
 */
  ...
  class Analytics{
    ...
    * @param int $iYear
    */
    public function setMonth($timestamp){  
        
        $this->_sStartDate = date('Y-m-01', $timestamp); 
        $this->_sEndDate   = date('Y-m-t', $timestamp);
    }
	public function setLastMonth(){  
        
        $this->_sStartDate = date('Y-m-01', strtotime("-1 month", time()));
        $this->_sEndDate   = date('Y-m-t', strtotime("-1 month", time()));
    }
	
	public function setYear(){  
        
        $this->_sStartDate = date('Y-m-d', strtotime("-1 year", time()));
        $this->_sEndDate   = date('Y-m-d');
    }
	public function setLastYear(){  
	...
	public function setToday(){  
        ...
        $this->_sStartDate = date('Y-m-d', time()); 
        $this->_sEndDate   = date('Y-m-d', time());
    }
    ...
    */
    public function getVisitors($period = 'month'){
                                
        return $this->getData(array( 'dimensions' => 'ga:'.$period.'',
                                     'metrics'    => 'ga:visits',
                                     'sort'       => 'ga:'.$period));
    }
	...
	* @param period day, month
    */    
    public function getPageviews($period = 'month'){
